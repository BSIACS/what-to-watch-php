...
class FilmFactory extends Factory
{
    ...
    {
        $randomFilm = $this->mockFilms[array_rand($this->mockFilms)];

        return [
            'id' => Str::uuid(),
            'name' => $randomFilm['name'],
            'poster_image' => $randomFilm['posterImage'],
            'preview_image' => $randomFilm['previewImage'],
            'background_image' => $randomFilm['backgroundImage'],
            'background_color' => $randomFilm['backgroundColor'],
            'released' => $randomFilm['released'],
            'description' => $randomFilm['description'],
            'director' => $randomFilm['director'],
            'starring' => $randomFilm['starring'],
            'run_time' => $randomFilm['runTime'],
            'video_link' => $randomFilm['videoLink'],
            'preview_video_link' => $randomFilm['previewVideoLink'],
            'rating' => $randomFilm['rating'],
            'score_count' => $randomFilm['scoreCount'],
        ];
    }
}
